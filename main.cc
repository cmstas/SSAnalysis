...
int main() {
  ...
  bool runSync = false;
  bool runBaby = true;
    bool usePtRel = false; //only used if making babies
  ...
  if (useSkim){
    ...
    chain_DY->Add(         dir+"DYJetsToLL_M-50_13TeV-madgraph-pythia8_Phys14DR-PU20bx25_PHYS14_25_V1-v1/"+tag2+"/merged_ntuple_*.root");
  }
