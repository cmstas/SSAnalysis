...
for i in "0"  # "1"
do
for sname in "DY" # "WJets" "TTBAR" "WZ" "DY" ""TTW" "TTZ" "T1TTTT_1500" "T1TTTT_1200" "T5qqqqWW_1200_1000_800" "T5qqqqWW_deg_1000_315_300" "DY1" "DY2" "DY3" "DY4" "WJets1" "WJets2" "WJets3" "WJets4"
do
