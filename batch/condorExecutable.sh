...
if [ "$WHICH" == "9" ]; then WHICH_SMALL="ttwqq"; fi
if [ "$WHICH" == "10" ]; then WHICH_SMALL="ttzq"; fi
if [ "$WHICH" == "11" ]; then WHICH_SMALL="ttg"; fi
...
if [ "$WHICH" == "16" ]; then WHICH_SMALL="singletop5"; fi
if [ "$WHICH" == "17" ]; then WHICH_SMALL="qqww"; fi
if [ "$WHICH" == "18" ]; then WHICH_SMALL="tttt"; fi
if [ "$WHICH" == "19" ]; then WHICH_SMALL="wwdps"; fi
if [ "$WHICH" == "20" ]; then WHICH_SMALL="ttbar_ph"; fi
if [ "$WHICH" == "21" ]; then WHICH_SMALL="wjets_lo"; fi
if [ "$WHICH" == "22" ]; then WHICH_SMALL="wwz"; fi
if [ "$WHICH" == "23" ]; then WHICH_SMALL="zz"; fi
