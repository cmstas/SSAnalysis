...
void SSAG::Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	lep1_isTrigSafeNoIsov1_branch = 0;
	if (tree->GetBranch("lep1_isTrigSafeNoIsov1") != 0) {
	...
	lep2_isTrigSafeNoIsov1_branch = 0;
	if (tree->GetBranch("lep2_isTrigSafeNoIsov1") != 0) {
