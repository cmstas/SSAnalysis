...
int analysis(){
  ...
  fixed_noFilt->Add("/hadoop/cms/store/user/cgeorge/SS_Syst_Study/qqWW/Babies/QQWW_mm_baby_1M_fixed_noFilt.root");
  ...
  notFixed_noFilt->Add("/hadoop/cms/store/user/cgeorge/SS_Syst_Study/qqWW/Babies/QQWW_mm_baby_1M_dynam_noFilt.root");

  TChain *notFixed_noFilt_pp = new TChain("Events");
  notFixed_noFilt_pp->Add("/hadoop/cms/store/user/cgeorge/SS_Syst_Study/qqWW/Babies/QQWW_pp_baby_1M_dynam_noFilt.root");
