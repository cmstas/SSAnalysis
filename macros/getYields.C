{
  ...
  /*
  TString dataset = "TTWJets";
  TFile *_file = TFile::Open(dir+"/"+dataset+"_histos.root");
  TH1F* hsr = (TH1F*) _file->Get("hyp_hihi_excl_sr");
  TH1F* hbr = (TH1F*) _file->Get("hyp_hihi_br");
  cout << "Dataset = " << dataset << endl
       << Form("BR0I=%.2f",hbr->GetBinContent(1)+hbr->GetBinContent(11)+hbr->GetBinContent(21)+hbr->GetBinContent(31))  << endl
       << Form("BR0E=%.2f",hbr->GetBinContent(1))  << endl
