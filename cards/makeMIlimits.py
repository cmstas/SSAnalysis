...
h.GetYaxis().SetTitle("95% CL #sigma #upoint A #upoint #varepsilon limit (fb)")
...
cmstex = ROOT.TLatex(0.575,0.91, "2.3 fb^{-1} (13 TeV)" )
cmstex.SetNDC()
...
l1.SetHeader("Model independent #sigma #upoint A #upoint #varepsilon exclusion limit")
...
masstex = ROOT.TLatex(0.60,0.79, "H_{T} > 300 GeV" )
masstex.SetNDC()
...
masstex = ROOT.TLatex(0.56,0.79, "50 < E_{T}^{miss} < 300 GeV" )
masstex.SetNDC()
masstex.SetTextSize(0.03)
masstex.SetLineWidth(2)
masstex.SetTextFont(42)
