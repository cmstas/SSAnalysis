...
h_xsec_p.GetYaxis().SetTitle("m_{#tilde{#chi_{1}^{0}}} (GeV)")
...
diagtex = ROOT.TLatex(0.20,0.40, "m_{#tilde{g}} - m_{#tilde{#chi}^{0}_{1}} = m_{W} + m_{b}" )
diagtex.SetNDC()
...
fout = ROOT.TFile("ss_t5ttcc_scan_xsec.root","RECREATE")
