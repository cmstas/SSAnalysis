...
if doMET:
    ...
    h = ROOT.TH2F("h","h",16,250,1050,magic,0,magic)
    h.SetTitle("")
    ...
    LExp.SetLineStyle(7)
    LExp.SetLineWidth(3)
    LExp.SetPoint(0,250+ 3.8*(1050-250)/100, magic-2.08*(magic-0)/100*10)
    LExp.SetPoint(1,250+21.2*(1050-250)/100, magic-2.08*(magic-0)/100*10)
    LExp.Draw("L")
