{
  ...
  TString intlumi="0.0161"; // fb^-1
  TString leptype = (doMu ? "Mu17" : "Ele12");


  if(doMu) {
      dataf = "/nfs-7/userdata/leptonTree/v0.14-16p1pb/2015CDoubleMuon.root";
  } else {
      dataf = "/nfs-7/userdata/leptonTree/v0.14-16p1pb/2015CDoubleEG.root";
  }

  dyf = "/nfs-7/userdata/leptonTree/v0.14-16p1pb/DY_madgraph.root";
