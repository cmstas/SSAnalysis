...
TH1F* GetErrorPlot(TH1F *pred, TH1F *obs, vector< vector<TH2D*> > pred_err2_mu, vector< vector<TH2D*> > pred_err2_el){

  TH1F *alexHist = (TH1F*)pred->Clone(); 
...
int ScanChain( TChain* chain, TString option = "", TString ptRegion = "HH", bool doData = false, int nEvents = -1){
  ...
  float luminosity = doData ? getLumi() : 3.0;
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	if (lep1_pT < 25. && lep2_pT < 25.) continue;
      ...
      float mult = 1.0;
      if(doData && !ss::is_real_data() && ss::hyp_class() == 2 && ss::lep1_motherID()==1 && ss::lep2_motherID()==1) {
      ...
      if( ( doData && (ss::is_real_data() && ss::hyp_class() == 2) ) || // if doing data, only fill pred with data
        ...
        if (lep1_passes_id && !lep2_passes_id){
          ...
          if (abs(ss::lep2_id()) == 11){  
            ...
            if (sr>=0) Npn_histo_sr_err2_pred_el[(ss::ht() > 300)][sr]->Fill(lep2_pT, fabs(ss::lep2_p4().eta()), w);
            ...
            if (sr>=0) Npn_histo_sr_err2_pred_mu[(ss::ht() > 300)][sr]->Fill(lep2_pT, fabs(ss::lep2_p4().eta()), w);
        ...
        if (!lep1_passes_id && lep2_passes_id){
          ...
          if( abs(ss::lep1_id()) == 11 ){	//if el, use el rate.  FILL WITH NONPROMPT			  
            ...
            if (sr>=0) Npn_histo_sr_err2_pred_el[(ss::ht() > 300)][sr]->Fill(lep1_pT, fabs(ss::lep1_p4().eta()), w);
            ...
            if (sr>=0) Npn_histo_sr_err2_pred_mu[(ss::ht() > 300)][sr]->Fill(lep1_pT, fabs(ss::lep1_p4().eta()), w);
  ...
  //BR plots
  dataMCplotMaker(hists[getHist("Npn_histo_br_pred")], { make_pair(hists[getHist("Npn_histo_br_obs")], GetErrorPlot(hists[getHist("Npn_histo_br_obs")], hists[getHist("Npn_histo_br_obs")], Npn_histo_br_err2_pred_mu, Npn_histo_br_err2_pred_el)) }, {"Observed"}, "BRs", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Baseline Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"br_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_br_pred_mu")], { make_pair(hists[getHist("Npn_histo_br_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_br_obs_mu")], hists[getHist("Npn_histo_br_obs_mu")], Npn_histo_br_err2_pred_mu, Npn_histo_br_err2_pred_el)) }, {"Observed"}, "BRs", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Baseline Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"br_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_br_pred_el")], { make_pair(hists[getHist("Npn_histo_br_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_br_obs_el")], hists[getHist("Npn_histo_br_obs_el")], Npn_histo_br_err2_pred_mu, Npn_histo_br_err2_pred_el)) }, {"Observed"}, "BRs", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Baseline Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"br_el"+option).Data()), {}, {}, { kYellow }); 

  //SR plots
  string typeAG = "HH";
  if (highlow) typeAG = "HL";
  if (lowlow)  typeAG = "LL";
  dataMCplotMaker(hists[getHist("Npn_histo_sr_pred")], { make_pair(hists[getHist("Npn_histo_sr_obs")], GetErrorPlot(hists[getHist("Npn_histo_sr_obs")], hists[getHist("Npn_histo_sr_obs")], Npn_histo_sr_err2_pred_mu, Npn_histo_sr_err2_pred_el)) }, {"Observed"}, Form("%s SRs", typeAG.c_str()), "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Signal Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"sr_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_sr_pred_mu")], { make_pair(hists[getHist("Npn_histo_sr_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_sr_obs_mu")], hists[getHist("Npn_histo_sr_obs_mu")], Npn_histo_sr_err2_pred_mu, Npn_histo_sr_err2_pred_el)) }, {"Observed"}, Form("%s SRs", typeAG.c_str()), "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Signal Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"sr_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_sr_pred_el")], { make_pair(hists[getHist("Npn_histo_sr_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_sr_obs_el")], hists[getHist("Npn_histo_sr_obs_el")], Npn_histo_sr_err2_pred_mu, Npn_histo_sr_err2_pred_el)) }, {"Observed"}, Form("%s SRs", typeAG.c_str()), "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel Signal Region --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"sr_el"+option).Data()), {}, {}, { kYellow }); 

  //HT plots
  dataMCplotMaker(hists[getHist("Npn_histo_HT_pred")], { make_pair(hists[getHist("Npn_histo_HT_obs")], GetErrorPlot(hists[getHist("Npn_histo_HT_obs")], hists[getHist("Npn_histo_HT_obs")], Npn_histo_HT_err2_pred_mu, Npn_histo_HT_err2_pred_el)) }, {"Observed"}, "H_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel H_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"HT_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_HT_pred_mu")], { make_pair(hists[getHist("Npn_histo_HT_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_HT_obs_mu")], hists[getHist("Npn_histo_HT_obs_mu")], Npn_histo_HT_err2_pred_mu, Npn_histo_HT_err2_pred_el)) }, {"Observed"}, "H_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel H_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"HT_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_HT_pred_el")], { make_pair(hists[getHist("Npn_histo_HT_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_HT_obs_el")], hists[getHist("Npn_histo_HT_obs_el")], Npn_histo_HT_err2_pred_mu, Npn_histo_HT_err2_pred_el)) }, {"Observed"}, "H_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel H_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"HT_el"+option).Data()), {}, {}, { kYellow }); 

  //MET plots
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred")], { make_pair(hists[getHist("Npn_histo_MET_obs")], GetErrorPlot(hists[getHist("Npn_histo_MET_obs")], hists[getHist("Npn_histo_MET_obs")], Npn_histo_MET_err2_pred_mu, Npn_histo_MET_err2_pred_el)) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred_mu")], { make_pair(hists[getHist("Npn_histo_MET_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_MET_obs_mu")], hists[getHist("Npn_histo_MET_obs_mu")], Npn_histo_MET_err2_pred_mu, Npn_histo_MET_err2_pred_el)) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred_el")], { make_pair(hists[getHist("Npn_histo_MET_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_MET_obs_el")], hists[getHist("Npn_histo_MET_obs_el")], Npn_histo_MET_err2_pred_mu, Npn_histo_MET_err2_pred_el)) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_el"+option).Data()), {}, {}, { kYellow }); 

  //MTMIN plots
  dataMCplotMaker(hists[getHist("Npn_histo_MTMIN_pred")], { make_pair(hists[getHist("Npn_histo_MTMIN_obs")], GetErrorPlot(hists[getHist("Npn_histo_MTMIN_obs")], hists[getHist("Npn_histo_MTMIN_obs")], Npn_histo_MTMIN_err2_pred_mu, Npn_histo_MTMIN_err2_pred_el)) }, {"Observed"}, "M_{T}^{min}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel M_{T}^{min} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MTMIN_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MTMIN_pred_mu")], { make_pair(hists[getHist("Npn_histo_MTMIN_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_MTMIN_obs_mu")], hists[getHist("Npn_histo_MTMIN_obs_mu")], Npn_histo_MTMIN_err2_pred_mu, Npn_histo_MTMIN_err2_pred_el)) }, {"Observed"}, "M_{T}^{min}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel M_{T}^{min} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MTMIN_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MTMIN_pred_el")], { make_pair(hists[getHist("Npn_histo_MTMIN_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_MTMIN_obs_el")], hists[getHist("Npn_histo_MTMIN_obs_el")], Npn_histo_MTMIN_err2_pred_mu, Npn_histo_MTMIN_err2_pred_el)) }, {"Observed"}, "M_{T}^{min}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel M_{T}^{min} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MTMIN_el"+option).Data()), {}, {}, { kYellow }); 

  //L1PT plots
  dataMCplotMaker(hists[getHist("Npn_histo_L1PT_pred")], { make_pair(hists[getHist("Npn_histo_L1PT_obs")], GetErrorPlot(hists[getHist("Npn_histo_L1PT_obs")], hists[getHist("Npn_histo_L1PT_obs")], Npn_histo_L1PT_err2_pred_mu, Npn_histo_L1PT_err2_pred_el)) }, {"Observed"}, "L1 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L1 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L1PT_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_L1PT_pred_mu")], { make_pair(hists[getHist("Npn_histo_L1PT_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_L1PT_obs_mu")], hists[getHist("Npn_histo_L1PT_obs_mu")], Npn_histo_L1PT_err2_pred_mu, Npn_histo_L1PT_err2_pred_el)) }, {"Observed"}, "L1 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L1 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L1PT_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_L1PT_pred_el")], { make_pair(hists[getHist("Npn_histo_L1PT_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_L1PT_obs_el")], hists[getHist("Npn_histo_L1PT_obs_el")], Npn_histo_L1PT_err2_pred_mu, Npn_histo_L1PT_err2_pred_el)) }, {"Observed"}, "L1 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L1 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L1PT_el"+option).Data()), {}, {}, { kYellow }); 

  //L2PT plots
  dataMCplotMaker(hists[getHist("Npn_histo_L2PT_pred")], { make_pair(hists[getHist("Npn_histo_L2PT_obs")], GetErrorPlot(hists[getHist("Npn_histo_L2PT_obs")], hists[getHist("Npn_histo_L2PT_obs")], Npn_histo_L2PT_err2_pred_mu, Npn_histo_L2PT_err2_pred_el)) }, {"Observed"}, "L2 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L2 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L2PT_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_L2PT_pred_mu")], { make_pair(hists[getHist("Npn_histo_L2PT_obs_mu")], GetErrorPlot(hists[getHist("Npn_histo_L2PT_obs_mu")], hists[getHist("Npn_histo_L2PT_obs_mu")], Npn_histo_L2PT_err2_pred_mu, Npn_histo_L2PT_err2_pred_el)) }, {"Observed"}, "L2 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L2 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L2PT_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_L2PT_pred_el")], { make_pair(hists[getHist("Npn_histo_L2PT_obs_el")], GetErrorPlot(hists[getHist("Npn_histo_L2PT_obs_el")], hists[getHist("Npn_histo_L2PT_obs_el")], Npn_histo_L2PT_err2_pred_mu, Npn_histo_L2PT_err2_pred_el)) }, {"Observed"}, "L2 p_{T}", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel L2 p_{T} --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 2.26 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"L2PT_el"+option).Data()), {}, {}, { kYellow }); 
