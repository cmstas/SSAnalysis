...
int ScanChain( TChain* chain, TString option = "", TString ptRegion = "HH", bool doData = false, int nEvents = -1){
  ...
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred")], { make_pair(hists[getHist("Npn_histo_MET_obs")], hists[getHist("Npn_histo_MET_obs")]) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 0.8 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_all"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred_mu")], { make_pair(hists[getHist("Npn_histo_MET_obs_mu")], hists[getHist("Npn_histo_MET_obs_mu")]) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 0.8 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_mu"+option).Data()), {}, {}, { kYellow }); 
  dataMCplotMaker(hists[getHist("Npn_histo_MET_pred_el")], { make_pair(hists[getHist("Npn_histo_MET_obs_el")], hists[getHist("Npn_histo_MET_obs_el")]) }, {"Observed"}, "MET", "t#bar{t} MC", Form("--outputName %s --outOfFrame --dataName Predicted --xAxisLabel MET --noDivisionLabel --noRatioPlot --isLinear --noOverflow --lumi 0.8 --noXaxisUnit --systBlack --systFillStyle 3345 --type Simulation --lumiPrec 1", (plotdir+"MET_el"+option).Data()), {}, {}, { kYellow }); 
