...
void SS::GetEntry(unsigned int idx) 
	...
	// load all branches
{
	...
	const vector<float> &SS::genweights()
	{
	...
	const vector<string> &SS::genweightsID()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep1_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep2_p4()
	{
	...
	const float &SS::lep1_coneCorrPt()
	{
	...
	const float &SS::lep2_coneCorrPt()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::jets()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::jets_corr()
	{
	...
	const vector<float> &SS::btags_disc()
	{
	...
	const vector<float> &SS::jets_disc()
	{
	...
	const vector<float> &SS::jets_JEC()
	{
	...
	const vector<float> &SS::btags_JEC()
	{
	...
	const vector<float> &SS::jets_undoJEC()
	{
	...
	const vector<float> &SS::btags_undoJEC()
	{
	...
	const vector<float> &SS::btags_corr_disc()
	{
	...
	const vector<float> &SS::jets_corr_disc()
	{
	...
	const vector<float> &SS::jets_corr_JEC()
	{
	...
	const vector<float> &SS::btags_corr_JEC()
	{
	...
	const vector<float> &SS::jets_corr_undoJEC()
	{
	...
	const vector<float> &SS::btags_corr_undoJEC()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::btags()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::btags_corr()
	{
	...
	const float &SS::sf_dilepTrig_hpt()
	{
	...
	const float &SS::sf_dilepTrig_lpt()
	{
	...
	const float &SS::sf_dilepTrig_vlpt()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep1_p4_gen()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep2_p4_gen()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep3_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep4_p4()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::dilep_p4()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::genps_p4()
	{
	...
	const vector<int> &SS::genps_id_mother()
	{
	...
	const vector<int> &SS::genps_idx_mother()
	{
	...
	const vector<int> &SS::genps_status()
	{
	...
	const vector<int> &SS::genps_id_grandma()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::jet_close_lep1()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::jet_close_lep2()
	{
	...
	const vector<int> &SS::eleID_kfhits()
	{
	...
	const vector<float> &SS::eleID_oldsigmaietaieta()
	{
	...
	const vector<float> &SS::eleID_oldsigmaiphiiphi()
	{
	...
	const vector<float> &SS::eleID_oldcircularity()
	{
	...
	const vector<float> &SS::eleID_oldr9()
	{
	...
	const vector<float> &SS::eleID_scletawidth()
	{
	...
	const vector<float> &SS::eleID_sclphiwidth()
	{
	...
	const vector<float> &SS::eleID_he()
	{
	...
	const vector<float> &SS::eleID_psEoverEraw()
	{
	...
	const vector<float> &SS::eleID_kfchi2()
	{
	...
	const vector<float> &SS::eleID_chi2_hits()
	{
	...
	const vector<float> &SS::eleID_fbrem()
	{
	...
	const vector<float> &SS::eleID_ep()
	{
	...
	const vector<float> &SS::eleID_eelepout()
	{
	...
	const vector<float> &SS::eleID_IoEmIop()
	{
	...
	const vector<float> &SS::eleID_deltaetain()
	{
	...
	const vector<float> &SS::eleID_deltaphiin()
	{
	...
	const vector<float> &SS::eleID_deltaetaseed()
	{
	...
	const vector<float> &SS::eleID_pT()
	{
	...
	const vector<bool> &SS::eleID_isbarrel()
	{
	...
	const vector<bool> &SS::eleID_isendcap()
	{
	...
	const vector<float> &SS::eleID_scl_eta()
	{
	...
	const vector<float> &SS::muID_dzPV()
	{
	...
	const vector<float> &SS::muID_ptSig()
	{
	...
	const vector<float> &SS::muID_ip3dSig()
	{
	...
	const vector<float> &SS::muID_medMuonPOG()
	{
	...
	const vector<float> &SS::muID_eta()
	{
	...
	const vector<float> &SS::trueNumInt()
	{
	...
	const vector<int> &SS::nPUvertices()
	{
	...
	const bool &	SS::lep1_trigMatch_noIsoReq()
	{
	...
	const bool &	SS::lep1_trigMatch_isoReq()
	{
	...
	const bool &	SS::lep2_trigMatch_noIsoReq()
	{
	...
	const bool &	SS::lep2_trigMatch_isoReq()
	{
	...
	const vector<float> &SS::jet_corr_pt()
	{
	...
	const bool &	SS::passes_met_filters()
	{
	...
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &SS::mostJets()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep1_closeJet()
	{
	...
	const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &SS::lep2_closeJet()
	{
	...
	const bool &	SS::passed_id_inSituFR_lep1()
	{
	...
	const bool &	SS::passed_id_inSituFR_lep2()
	{
	...
	const unsigned int &SS::triggers()
	{
  ...
  void SS::progress( int nEventsTotal, int nEventsChain ){
    int period = 1000;
