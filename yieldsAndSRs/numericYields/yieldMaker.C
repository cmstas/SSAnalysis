...
int which_lep = -1; // lepton plots for specific flavor (11, 13) or -1 for all (default)
...
void getyields(){
  ...
  // // //Get yields
  #include "fs_t1tttt.h" // FIXME only enabled the first mass point
